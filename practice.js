...
projects.forEach((project) => {
  ...
  modal.innerHTML = `
      ...
      src="./img/cross.png" data-target = "modal-${project.id}">
...
const btns = document.querySelectorAll(".open-popup-btn");
const backdrop = document.getElementById("backdrop");

btns.forEach(function (btn) {
  btn.addEventListener("click", function () {
    var modal = btn.getAttribute("data-target");
    var clickedModal = document.getElementById(modal);

    backdrop.classList.remove("backdrop-hidden");
    clickedModal.classList.remove("modal-hidden");
  });
});

const closeBtns = document.querySelectorAll(".close_popup");
closeBtns.forEach(function (closeBtn) {
  closeBtn.addEventListener("click", function () {
    var modalClose = closeBtn.getAttribute("data-target");
    document.getElementById(modalClose).classList.add("modal-hidden");
    backdrop.classList.add("backdrop-hidden");
  });
});
